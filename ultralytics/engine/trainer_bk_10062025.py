...
class BaseTrainer:
    ...
    def optimizer_step(self):
        """Perform one optimizer step with gradient clipping and EMA update."""
        self.scaler.unscale_(self.optimizer)  # unscale gradients for accurate clipping
    ...
    def get_dataloader(self, dataset_path, batch_size=16, rank=0, mode="train"):
        """Must be implemented by subclasses to return a DataLoader."""
        raise NotImplementedError("get_dataloader function not implemented in BaseTrainer.")
